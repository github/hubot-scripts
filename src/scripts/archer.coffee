...
module.exports = (robot) ->
  ...
  robot.hear /^loggin/i,{id: 'archer.kenny.loggins'}, (msg) ->
    msg.reply "call Kenny Loggins, 'cuz you're in the DANGER ZONE."

  robot.hear /^sitting down/i,{id: 'archer.sitting.down'}, (msg) ->
    msg.reply "What?! At the table? Look, he thinks he's people!"

  robot.hear /archer/i,{id: 'archer.random.quote'}, (msg) ->
  ...
  unless process.env.HUBOT_ARCHER_SFW
    ...
    robot.hear /^benoit/i,{id: 'archer.benoit'}, (msg) ->
      msg.send "balls"

    robot.hear /love/i,{id: 'archer.love'}, (msg) ->
