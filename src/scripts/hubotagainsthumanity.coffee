...
questions = [
  ...
  "(Draw 2, Pick 3) I went from – to _____, all thanks to.",
  "(Pick 2) _____ would be woefully incomplete without _____.",
  "(Pick 2) – is a slippery slope that leads to _____.",
  "(Pick 2) An international tribunal has found – guilty of _____.",
  "(Pick 2) An the Academy Award for – goes to _____.",
  "(Pick 2) Before _____, all we had was_____.",
  "(Pick 2) Dear Sir or Madam, We regret to inform you that the office of – has denied your request for _____.",
  "(Pick 2) For my next trick, I will pull – out of _____.",
  "(Pick 2) I never truly understood – until I encountered _____.",
  ...
  "(Pick 2) In M. Night Shamalan's new movie, Bruce Willis discovers that _____ had really been – all along."
  "(Pick 2) Lifetime presents _____, the story of _____.",
  "(Pick 2) Michael Bay's new three_____hour action epic pits – against _____.",
  ...
  "(Pick 2) When I was tripping on acid – turned into _____.",
  ...
  "During Picasso's often_____overlooked Brown Period, he produced hundreds of paintings of _____.",
  ...
  "In his new self_____produced album, Kanye West raps over the sounds of _____.",
  ...
  "This holiday season, Tim Allen must overcome his fear of – to save Christmas.",
  ...
  "When I am a billionaire, I shall erect a 50_____foot statue to commemorate _____.",
