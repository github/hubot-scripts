...
module.exports = (robot) ->
  ...
  robot.respond /.*4d3d3d3/i, (msg) ->
    ...
    msg.send "https://i.imgur.com/w1qQO.gif"
  robot.respond /.*add sequence:? oyster/i, (msg) ->
    msg.send "https://i.imgur.com/9McEqKA.gif"
  robot.respond /.*oyster smiling/, (msg) ->
    # msg.send "https://i.imgur.com/e71P6.png"
    msg.send "https://i.imgur.com/eq5v0RY.gif"
